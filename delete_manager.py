...
# TODO: fix when archiving the first note, it disappears, only the second note appears in the window
class DeleteManager:
    ...
    def add_note_to_delete(self, note_text):
        ...
        # Creating buttons
        delete_button = QtWidgets.QPushButton("Удалить", delete_note)
        archive_button = QtWidgets.QPushButton("Архивировать", delete_note)
        remind_button = QtWidgets.QPushButton("Напомнить", delete_note)
        ...
        delete_note.enterEvent = self.create_enter_event_handler(delete_button, archive_button, remind_button,
                                                                  show_text_button)
        delete_note.leaveEvent = self.create_leave_event_handler(delete_button, archive_button, remind_button,
                                                                  show_text_button)
    ...
    def restore_notes(self):
        for note_text, x, y in self.notes:
            ...
            delete_note.setGeometry(x, y, 250, 170)
            delete_note.show()
