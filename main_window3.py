...
"")
        ...
        self.layoutWidget.setGeometry(QRect(0, 0, 196, 286))
        ...
        icon = QIcon()
        icon.addFile(u"../../Downloads/notes_24dp_FILL0_wght400_GRAD0_opsz24 (1).svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.TrashButtMW_2 = QPushButton(self.layoutWidget)
        self.TrashButtMW_2.setObjectName(u"TrashButtMW_2")
        self.TrashButtMW_2.setStyleSheet(
            "QPushButton {"
            "   border: 1px solid rgb(0,0,0);"
            "   background-color: rgb(255, 239, 205);"
            "   border-radius: 7px;"
        ...
        icon4 = QIcon()
        icon4.addFile(u"../../Downloads/ios_share_24dp_FILL0_wght400_GRAD0_opsz24 (1).svg", QSize(), QIcon.Normal, QIcon.Off)
        self.TrashButtMW_2.setIcon(icon4)
        self.TrashButtMW_2.setIconSize(QSize(24, 24))
        self.TrashButtMW_2.setAutoRepeat(False)

        self.verticalLayout.addWidget(self.TrashButtMW_2)

        self.verticalLayoutWidget = QWidget(self.centralwidget)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(310, 20, 581, 91))
